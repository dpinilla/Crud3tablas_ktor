    ...
    Scaffold(
        ...
        Column(
            ...
            TextField(
                ...
                Modifier.fillMaxWidth(),
                label = { Text(stringResource(Res.string.cedula)) }
            )
            espacio()
            TextField(
                value = nombre,
            ...
            Button(
                onClick = {
                    ...
                    insertaViewModel.guardar(
                        ModelCliente(cedula, nombre, edad.toInt()),
                        onSuccess = {
                            scope.launch {
                            ...
                            //Toast.makeText(context, toastGuardar, Toast.LENGTH_SHORT).show()
                        ...
                        onError = {
                            ...
                            //Toast.makeText(context, toastErrorGuardar, Toast.LENGTH_SHORT).show()
                        }
                    )
                },
                Modifier.fillMaxWidth()
